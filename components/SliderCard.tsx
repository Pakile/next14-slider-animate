...
function SliderCard({data}: Props) {
  return (
    <motion.div
      className=" relative h-52 min-w-[250px] rounded-2xl shadow-md md:h-64 md:min-w-[180px]"
      layout
    ...
    >
      <motion.img
        ...
        src={data.img}
        className=" absolute h-full w-full  rounded-3xl  object-cover brightness-75 "
      />
